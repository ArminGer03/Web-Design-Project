...
const ProtectedRoute = ({ children }) => {
    ...
    try {
        ...
        const allowedPaths = ['/player-dashboard', '/designer-dashboard', '/questions-management', '/categories-management', '/leaderboard', '/player-questions', '/player-categories', '/answered-questions'];
